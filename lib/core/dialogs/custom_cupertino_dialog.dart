...
const Color _kDialogColor = CupertinoDynamicColor.withBrightness(
  ...
  darkColor: AppColors.darkForeground,
);
...
const Color _kActionSheetButtonDividerColor = Colors.grey;
...
///
/// {@tool dartpad}
/// This sample shows how to use a [CustomCupertinoAlertDialog].
///	The [CustomCupertinoAlertDialog] shows an alert with a set of two choices
...
/// rendering divider gaps for a more complicated layout, e.g., [CustomCupertinoAlertDialog].
...
/// See also:
///
///  * [CustomCupertinoAlertDialog], which is a dialog with a title, content, and
///    actions.
///  * <https://developer.apple.com/ios/human-interface-guidelines/views/alerts/>
...
/// A button typically used in a [CustomCupertinoAlertDialog].
///
/// See also:
///
///  * [CustomCupertinoAlertDialog], a dialog that informs the user about situations
...
class _CupertinoDialogActionsRenderWidget extends MultiChildRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    return _RenderCupertinoDialogActions(
      ...
      dividerColor: CupertinoDynamicColor.resolve(Colors.grey, context),
